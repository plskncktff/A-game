...
std::chrono::milliseconds pause_after_text = std::chrono::milliseconds(1500);
...
void game_over_screen(std::string game_over_text)
{
	...
	{
		animate_text("The twins got you.");
		clrscr();
		std::cout << "Game over.\n\nPress Enter to exit.";
		std::cin.get();
	}
...
std::string use_scribe_skill(std::vector<std::string> scribe_skill)
{
	...
	clrscr();
	std::cout << "\n	Runes:\n\n";
	std::cout << "1. " << scribe_skill[0] << " - stable: 1dmg/turn for 3 turns; unstable: also 2 dmg to scribe." << std::endl;
	std::cout << "2. " << scribe_skill[1] << " - stable: 1dmg/turn for 3 turns, if has other curses; unstable: also 1 dmg/turn to scribe." << std::endl;
	std::cout << "3. " << scribe_skill[2] << " - stable: all cursses deal dmg immediately; unstable: also dmg to scribe." << std::endl;
	std::cout << "4. " << scribe_skill[3] << " - stable: 3-1 dmg/turn based on hp; unstable: 3-1san.dmg/turn to scribe." << std::endl;
	...
	case 49:
		if (runes > 0)
		{
			...
			clrscr();
			animate_text(scribe_skill[0] + " used.");
		}
		else
		{
			clrscr();
			animate_text("You don't have enough runes carved.");
			skill_used = "Runes";
		}
	...
	case 50:
		if (runes > 0)
		{
			...
			clrscr();
			animate_text(scribe_skill[1] + " used.");
		}
		else
		{
			clrscr();
	...
	case 51:
		if (runes > 0)
		{
			...
			clrscr();
			animate_text(scribe_skill[2] + " used.");
		}
		else
		{
			clrscr();
	...
	case 52:
		if (runes > 1)
		{
			...
			clrscr();
			animate_text(scribe_skill[3] + " used.");
		}
		else
		{
			clrscr();
...
std::string use_veteran_skill(std::vector<std::string> veteran_skill)
{
	...
	case 49:
		...
		{
			clrscr();
			animate_text(veteran_skill[0] + " used.");
			clrscr();
			if (!used_trauma)
			{
			...
			{
				animate_text("Your guard tightens as your mind shuts in.\nDefense increased!");
			}
		...
		{
			clrscr();
			animate_text("Your mind is too strained, you cannot focus.");
			skill_used = "Mind";
		}
		break;
	...
	case 50:
		...
		{
			clrscr();
			animate_text(veteran_skill[1] + " used.");
			clrscr();
			if (!used_focus)
			{
			...
			{
				animate_text("Your blood boils with guided rage.\nDamage increased!");
			}
	...
	case 51:
		...
		{
			clrscr();
			animate_text(veteran_skill[2] + " used.");
			clrscr();
			if (!used_disregard)
			{
			...
			{
				animate_text("You command your body to forego caution - the force of your blow cuts both ways.\nBonus damage to enemy at the cost of your own blood!");
			}
		...
		{
			clrscr();
			animate_text("Your body needs to recover to go beyond limit again.");
			skill_used = "Body";
		}
		break;
	...
	case 52:
		...
		{
			clrscr();
			animate_text("You've already mastered this enemy's patterns.");
			skill_used = "None";
		}
		break;
...
std::string use_spell(std::vector<std::string> spellbook)
{
	...
	clrscr();
	std::cout << "\n	Spellbook:\n\n";
	std::cout << "1. " << spellbook[0] << " - moderate dmg + stun for 1 turn; 6 san." << std::endl;
	std::cout << "2. " << spellbook[1] << " - minor dmg + incresed miss chance; 2 san." << std::endl;
	std::cout << "3. " << spellbook[2] << " - minor dmg + decreased dmg; 2 san." << std::endl;
	std::cout << "4. " << spellbook[3] << " - heavy dmg + decreased def; 2 san." << std::endl;
	...
	case 49:
		...
		if (player_san_current > 6)
		{
			...
			{
				clrscr();
				animate_text("Static elemental strikes the enemy with lightning.\nYour head spins wildly.\nThe enemy is stunned and cannot act!\n");
			}
		}
		else
		{
			animate_text("Your mind is too weak to cast this conjuration.");
			spell_used = "Mind";
		}
		break;
	...
	case 50:
		...
		if (player_san_current > 2)
		{
			...
			{
				clrscr();
				animate_text("Water elemental whips the enemy's eyes with pressurized water.\nThe enemy is almost blind!");
			}
		}
		else
		{
	...
	case 51:
		...
		if (player_san_current > 2)
		{
			...
			{
				clrscr();
				animate_text("Earth elemental slams rocks into the enemy.\nThe enemy is significantly encumbered!");
			}
		}
		else
		{
	...
	case 52:
		...
		if (player_san_current > 10)
		{
			...
			{
				clrscr();
				animate_text("Fire elemental ignites the enemy.\nThe enemy is defenseless!");
			}
		}
		else
		{
...
void combat(char monster)
{
	...
	if (monster == '*')
	{
		...
		{
			animate_text("A writhing mass of flesh, skin, and eyes floats menacingly towards you.");
		}
		monster_hp_max = 25;
	...
	{
		clrscr();
		animate_text("Another misfortunate soul stands in your way.");
		monster_hp_max = 15;
		monster_hp_current = monster_hp_max;
	...
	else if (monster == '&')
	{
		...
		{
			clrscr();
			animate_text("A slug made of human remains is hissing at you.");
		}
		monster_hp_max = 35;
		monster_hp_current = monster_hp_max;
		monster_damage_max = 3;
	...
	else if (monster == '%')
	{
		...
		{
			clrscr();
			animate_text("A two-headed figure stands before you, carefully anticipating your moves.");
		}
		monster_hp_max = 30;
		monster_hp_current = monster_hp_max;
	...
	while (monster_hp_current > 0 && player_hp_current > 0 && player_san_current > 0 && !game_over)
	{
		...
		while (!action_chosen)
		{
			...
			case 49:
				action_chosen = true;
				clrscr();
				animate_text("You take a swing at the enemy...");
				if (is_hit(player_miss_chance_max - player_miss_chance_bonus))
				{
					...
					animate_text(" and get a clean hit.");
					if (was_crit)
					{
						animate_text(" Critical hit!");
						was_crit = false;
					}
					if (total_damage <= 0)
					{
						animate_text(" But your attack has no effect.");
						total_damage = 0;
					}
			...
			case 50:
				action_chosen = true;
				clrscr();
				animate_text("You steel your posture and raise your armaments. Defense increased!");
			...
			case 51:
				...
				{
					clrscr();
					animate_text("You have no time to use another item.");
				}
				break;
			...
			case 52:
				action_chosen = true;
				clrscr();
				animate_text("You disregard the enemy's advance with idle indifference.");
				break;
			...
			case 53:
				...
				{
					clrscr();
					animate_text("Your disregard for your own mind has cost you precious opportunity.");
					break;
				}
				else if (skill_selected == "Body")
				{
					clrscr();
					animate_text("Your disregard for your own body has cost you precious opportunity.");
					break;
				}
				else if (skill_selected == "Runes")
				{
					clrscr();
					animate_text("Your meddling with the runes has cost you precious opportunity.");
				}
				else if (skill_selected == "None")
				{
					clrscr();
					animate_text("Your hesitation has cost you precious opportunity.");
					break;
				}
				...
				else if (skill_selected == "Bloodboil rune" || skill_selected == "Bloodboil rune unstable")
				{
					...
					{
						animate_text(" Crimson cracks cover the rune, and it crumbles to small pieces.");
						...
						{
							clrscr();
							animate_text("The enemy's blood boils!");
						}
					}
					else if (skill_selected == "Bloodboil rune unstable")
					{
						animate_text(" The rune starts melting into vivid red liquid that cuts your hand.");
						player_hp_current -= 2;
						...
						{
							clrscr();
							animate_text("Your hand is bleeding.\nThe enemy's blood boils!");
						}
					}
				...
				else if (skill_selected == "Plague rune" || skill_selected == "Plague rune unstable")
				{
					...
					{
						animate_text(" The rune decays and turns into dust.");
						...
						{
							clrscr();
							animate_text("The enemy's resilience is weakened significantly!");
						}
					}
					else if (skill_selected == "Plague rune unstable")
					{
						animate_text(" The rune covers in pustules and ulcers, emitting a vile stench, then bursts into vile liquid and melts entirely.");
				...
				else if (skill_selected == "Collapse rune" || skill_selected == "Collapse rune unstable")
				{
					...
					{
						animate_text(" The runes impossibly merge until both disappear.");
						...
						if (!used_collapse)
						{
							...
							{
								clrscr();
								animate_text("The enemy is not affected in any way.");
							}
						}
						else
						{
							...
							{
								clrscr();
								animate_text("The burden of curses affecting the enemy collapses to a singularity!");
							}
							else
							{
								clrscr();
					...
					{
						runes -= 2;
						animate_text(" The runes start distorting until both become an unusable mess covered in illegible writings.");
						...
						else
						{
							if (bloodboil_duration > 0 || plague_duration > 0 || entropy_duration > 0)
							{
								animate_text("The burden of curses affecting the enemy collapses to a singularity that resonates with your body!");
							}
							else
							{
								clrscr();
				...
				else if (skill_selected == "Entropy rune" || skill_selected == "Entropy rune unstable")
				{
					...
					{
						animate_text(" The runes are violently pressed into thin crusts, which then erode quickly.");
						if (!used_entropy)
						{
							clrscr();
						...
						{
							clrscr();
							animate_text("The enemy's health is being drained!");
						}
						entropy_duration += 3;
					}
					else if (skill_selected == "Entropy rune unstable")
					{
						...
						animate_text(" The runes glow in an unnerving kaleidoscope of muted colors.");
						if (!used_entropy)
						{
							clrscr();
						...
						{
							clrscr();
							animate_text("The enemy's health and your sanity are being drained!");
						}
						entropy_duration += 3;
		...
		if (monster == '*' && monster_hp_current <= monster_hp_max * 0.5)
		{
			...
			{
				clrscr();
				animate_text("The creature grows additional appendages, slithering from the wounds you dealt!");
		...
		else if (monster == '&' && player_san_current <= player_san_max * 0.5)
		{
			...
			{
				clrscr();
				animate_text("The creature suddenly looks sharper, a myriad of tiny claws erupt from it.\nAny strike will cause you damage!");
				monster_transformed = true;
			}
		}
		...
		if (!monster_turn_skip && monster_hp_current > 0 && player_hp_current > 0 && player_san_current > 0)
		{
			if (monster == '*' && monster_transformed)
			{
				...
				{
					animate_text("The mass' additional appendages swing...");
					if (is_hit(monster_miss_chance + miss_chance_increase))
					{
						animate_text(" and cleave through your flesh!");
						player_hp_current -= 3;
					}
					else
					{
			...
			clrscr();
			animate_text("The enemy swings at you...");
			if (is_hit(monster_miss_chance + miss_chance_increase))
			{
				animate_text(" and hits you cleanly.");
				...
				if (total_damage <= 0)
				{
					animate_text(" But you managed to block the attack just in time.");
					total_damage = 0;
				}
		...
		else
		{
			...
			{
				animate_text("The enemy is unable to act.");
			}
		}
